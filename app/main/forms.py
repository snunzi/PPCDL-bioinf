...
class CreateRun(FlaskForm):
    ...
    run_id = TextAreaField(('Run ID (No Spaces; For Illumina, use Illumina folder name i.g. YYMMDD_InstrumentID_RunID_FlowcellID)'), validators=[DataRequired(), Regexp(r'^[\w.@+-]+$')])
